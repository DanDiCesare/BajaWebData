...
NUITKA_CROSS_MODULE PyObject *impl___internal__$$$function_6_complex_call_helper_keywords_star_list_star_dict(PyObject **python_pars);
...
NUITKA_CROSS_MODULE PyObject *impl___internal__$$$function_6_complex_call_helper_keywords_star_list_star_dict(PyObject **python_pars) {
...

    {
...

        {
            ...
            branch_yes_7:;
            {
                ...
                PyObject *tmp_source_name_2;
                PyObject *tmp_type_arg_4;
                tmp_left_name_4 = const_str_digest_adc474dd61fbd736d69c1bac5d9712e0;
                CHECK_OBJECT(par_called);
    ...
    // tried codes exits in all cases
    NUITKA_CANNOT_GET_HERE(__internal__$$$function_6_complex_call_helper_keywords_star_list_star_dict);
    return NULL;
    // Return handler code:
    try_return_handler_1:;
    Py_XDECREF(par_kw);
...
NUITKA_CROSS_MODULE PyObject *impl___internal__$$$function_7_complex_call_helper_pos_keywords_star_dict(PyObject **python_pars) {
    ...
    // tried codes exits in all cases
    NUITKA_CANNOT_GET_HERE(__internal__$$$function_7_complex_call_helper_pos_keywords_star_dict);
    return NULL;
    // Return handler code:
    try_return_handler_1:;
    Py_XDECREF(par_kw);
...
NUITKA_CROSS_MODULE PyObject *impl___internal__$$$function_8_complex_call_helper_pos_star_list_star_dict(PyObject **python_pars) {
    ...
    // tried codes exits in all cases
    NUITKA_CANNOT_GET_HERE(__internal__$$$function_8_complex_call_helper_pos_star_list_star_dict);
    return NULL;
    // Return handler code:
    try_return_handler_1:;
    CHECK_OBJECT((PyObject *)par_star_arg_list);
...
NUITKA_CROSS_MODULE PyObject *impl___internal__$$$function_9_complex_call_helper_keywords_star_list(PyObject **python_pars) {
    ...
    // tried codes exits in all cases
    NUITKA_CANNOT_GET_HERE(__internal__$$$function_9_complex_call_helper_keywords_star_list);
    return NULL;
    // Return handler code:
    try_return_handler_1:;
    CHECK_OBJECT((PyObject *)par_star_arg_list);
...
NUITKA_CROSS_MODULE PyObject *impl___internal__$$$function_10_complex_call_helper_pos_star_dict(PyObject **python_pars) {
    ...
    // tried codes exits in all cases
    NUITKA_CANNOT_GET_HERE(__internal__$$$function_10_complex_call_helper_pos_star_dict);
    return NULL;
    // Return handler code:
    try_return_handler_1:;
    CHECK_OBJECT((PyObject *)par_star_arg_dict);
...
NUITKA_CROSS_MODULE PyObject *impl___internal__$$$function_11_complex_call_helper_keywords_star_dict(PyObject **python_pars) {
    ...
    // tried codes exits in all cases
    NUITKA_CANNOT_GET_HERE(__internal__$$$function_11_complex_call_helper_keywords_star_dict);
    return NULL;
    // Return handler code:
    try_return_handler_1:;
    Py_XDECREF(par_kw);
