...
extern PyObject *const_tuple_type_str_type_unicode_tuple;
...
static void createModuleConstants(void) {
    const_str_plain_base_str = UNSTREAM_STRING(&constant_bin[ 289952 ], 8, 1);
    const_str_digest_58e9489883b2042138fb899ca75ed20c = UNSTREAM_STRING(&constant_bin[ 289960 ], 23, 0);
    const_str_digest_e2cc425e5e8221f9dfdf6830ebef8985 = UNSTREAM_STRING(&constant_bin[ 289983 ], 17, 0);
...
static PyCodeObject *codeobj_42ee28b2788375c798a9513168a49535;

static void createModuleCodeObjects(void) {
    module_filename_obj = MAKE_RELATIVE_PATH(const_str_digest_e2cc425e5e8221f9dfdf6830ebef8985);
    codeobj_42ee28b2788375c798a9513168a49535 = MAKE_CODEOBJECT(module_filename_obj, 1, CO_NOFREE, const_str_digest_58e9489883b2042138fb899ca75ed20c, const_tuple_empty, 0, 0, 0);
}
...
PyObject *modulecode_chardet$compat(char const *module_full_name) {
...
#else
    mdef_chardet$compat.m_name = module_full_name;
...
#if PYTHON_VERSION >= 300
    {
        int r = PyDict_SetItemString(PyImport_GetModuleDict(), module_full_name, module_chardet$compat);
        assert(r != -1);
    }
#endif
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_42ee28b2788375c798a9513168a49535;
    ...
    // Frame without reuse.
    frame_42ee28b2788375c798a9513168a49535 = MAKE_MODULE_FRAME(codeobj_42ee28b2788375c798a9513168a49535, module_chardet$compat);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack(frame_42ee28b2788375c798a9513168a49535);
    assert(Py_REFCNT(frame_42ee28b2788375c798a9513168a49535) == 2);
...
#if 0
    RESTORE_FRAME_EXCEPTION(frame_42ee28b2788375c798a9513168a49535);
#endif
    popFrameStack();

    assertFrameObject(frame_42ee28b2788375c798a9513168a49535);
    ...
    {
        exception_tb = MAKE_TRACEBACK(frame_42ee28b2788375c798a9513168a49535, exception_lineno);
    }
    else if (exception_tb->tb_frame != &frame_42ee28b2788375c798a9513168a49535->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_42ee28b2788375c798a9513168a49535, exception_lineno);
    }
