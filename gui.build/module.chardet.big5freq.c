...
static PyObject *const_str_digest_1a2aee80378d5eeb021b30a61877144b;
...
static void createModuleConstants(void) {
    const_str_digest_1a2aee80378d5eeb021b30a61877144b = UNSTREAM_STRING(&constant_bin[ 260031 ], 19, 0);
    const_tuple_0d344fc43c8fde1f903c0a27df00c4dd_tuple = PyMarshal_ReadObjectFromString((char *)&constant_bin[ 260050 ], 26885);
...
static void createModuleCodeObjects(void) {
    module_filename_obj = MAKE_RELATIVE_PATH(const_str_digest_1a2aee80378d5eeb021b30a61877144b);
}
...
PyObject *modulecode_chardet$big5freq(char const *module_full_name) {
...
#ifdef _NUITKA_TRACE
    PRINT_STRING("chardet.big5freq: Calling createModuleConstants().\n");
#endif
    createModuleConstants();

    /* The code objects used by this module are created now. */
#ifdef _NUITKA_TRACE
    PRINT_STRING("chardet.big5freq: Calling createModuleCodeObjects().\n");
#endif
...
#else
    mdef_chardet$big5freq.m_name = module_full_name;
...
#if PYTHON_VERSION >= 300
    {
        int r = PyDict_SetItemString(PyImport_GetModuleDict(), module_full_name, module_chardet$big5freq);
        assert(r != -1);
    }
#endif
...
// Mark the execution in the "__spec__" value.
    ...
    }
    {
        ...
        UPDATE_STRING_DICT0(moduledict_chardet$big5freq, (Nuitka_StringObject *)const_str_plain_BIG5_TYPICAL_DISTRIBUTION_RATIO, tmp_assign_source_3);
    }
    {
        PyObject *tmp_assign_source_4;
        tmp_assign_source_4 = const_int_pos_5376;
        UPDATE_STRING_DICT0(moduledict_chardet$big5freq, (Nuitka_StringObject *)const_str_plain_BIG5_TABLE_SIZE, tmp_assign_source_4);
    }
    {
        PyObject *tmp_assign_source_5;
        tmp_assign_source_5 = const_tuple_0d344fc43c8fde1f903c0a27df00c4dd_tuple;
        UPDATE_STRING_DICT0(moduledict_chardet$big5freq, (Nuitka_StringObject *)const_str_plain_BIG5_CHAR_TO_FREQ_ORDER, tmp_assign_source_5);
    }
