...
static void createModuleConstants(void) {
    const_str_digest_7d0d43f7b3453d978385b35090ab7129 = UNSTREAM_STRING(&constant_bin[ 567446 ], 18, 0);
    const_str_digest_96baa068c2199be2cd71dcff3a585dfa = UNSTREAM_STRING(&constant_bin[ 567464 ], 24, 0);
    const_str_digest_273bc0eb91233c9ce50bbc2a025b5f82 = UNSTREAM_STRING(&constant_bin[ 567488 ], 179, 0);
    const_str_digest_5f28c8ec13a43e2288b9f6b9b20df422 = UNSTREAM_STRING(&constant_bin[ 246327 ], 5, 0);
...
static PyCodeObject *codeobj_caab1699685dd96049107c7a65193d62;

static void createModuleCodeObjects(void) {
    module_filename_obj = MAKE_RELATIVE_PATH(const_str_digest_7d0d43f7b3453d978385b35090ab7129);
    codeobj_caab1699685dd96049107c7a65193d62 = MAKE_CODEOBJECT(module_filename_obj, 1, CO_NOFREE, const_str_digest_96baa068c2199be2cd71dcff3a585dfa, const_tuple_empty, 0, 0, 0);
}
...
PyObject *modulecode_chardet$version(char const *module_full_name) {
...
#ifdef _NUITKA_TRACE
    PRINT_STRING("chardet.version: Calling createModuleConstants().\n");
#endif
    createModuleConstants();

    /* The code objects used by this module are created now. */
#ifdef _NUITKA_TRACE
    PRINT_STRING("chardet.version: Calling createModuleCodeObjects().\n");
#endif
...
#else
    mdef_chardet$version.m_name = module_full_name;
...
#if PYTHON_VERSION >= 300
    {
        int r = PyDict_SetItemString(PyImport_GetModuleDict(), module_full_name, module_chardet$version);
        assert(r != -1);
    }
#endif
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_caab1699685dd96049107c7a65193d62;
    ...
    // Frame without reuse.
    frame_caab1699685dd96049107c7a65193d62 = MAKE_MODULE_FRAME(codeobj_caab1699685dd96049107c7a65193d62, module_chardet$version);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack(frame_caab1699685dd96049107c7a65193d62);
    assert(Py_REFCNT(frame_caab1699685dd96049107c7a65193d62) == 2);
    ...
    // Framed code:
    {
        ...
        tmp_mvar_value_1 = GET_STRING_DICT_VALUE(moduledict_chardet$version, (Nuitka_StringObject *)const_str_plain___version__);
        ...
        frame_caab1699685dd96049107c7a65193d62->m_frame.f_lineno = 9;
...
#if 0
    RESTORE_FRAME_EXCEPTION(frame_caab1699685dd96049107c7a65193d62);
#endif
    popFrameStack();

    assertFrameObject(frame_caab1699685dd96049107c7a65193d62);
    ...
    {
        exception_tb = MAKE_TRACEBACK(frame_caab1699685dd96049107c7a65193d62, exception_lineno);
    }
    else if (exception_tb->tb_frame != &frame_caab1699685dd96049107c7a65193d62->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_caab1699685dd96049107c7a65193d62, exception_lineno);
    }
