...
static void createModuleConstants(void) {
    const_str_digest_1fc6d535b482ffda13f12c1e26c32ada = UNSTREAM_STRING(&constant_bin[ 592307 ], 16, 0);
    const_str_digest_b74524253192e0d351f72247f812e768 = UNSTREAM_STRING(&constant_bin[ 592323 ], 23, 0);
    const_str_digest_35bf456dd5109607ecb32c64870ea13f = UNSTREAM_STRING(&constant_bin[ 592346 ], 51, 1);
    const_str_digest_0b371e257c69d9828d44c48d33538c21 = UNSTREAM_STRING(&constant_bin[ 592397 ], 48, 0);
    const_str_digest_7e628d76d5bb40493758304c7212ec63 = UNSTREAM_STRING(&constant_bin[ 592445 ], 45, 0);
...
static PyCodeObject *codeobj_f5eede0aaa9da5fbf6fc1c112aa8f591;

static void createModuleCodeObjects(void) {
    module_filename_obj = MAKE_RELATIVE_PATH(const_str_digest_0b371e257c69d9828d44c48d33538c21);
    codeobj_f5eede0aaa9da5fbf6fc1c112aa8f591 = MAKE_CODEOBJECT(module_filename_obj, 1, CO_NOFREE | CO_FUTURE_DIVISION | CO_FUTURE_ABSOLUTE_IMPORT | CO_FUTURE_PRINT_FUNCTION, const_str_digest_7e628d76d5bb40493758304c7212ec63, const_tuple_empty, 0, 0, 0);
}
...
PyObject *modulecode_cryptography$hazmat$bindings$openssl(char const *module_full_name) {
...
#else
    mdef_cryptography$hazmat$bindings$openssl.m_name = module_full_name;
...
#if PYTHON_VERSION >= 300
    {
        int r = PyDict_SetItemString(PyImport_GetModuleDict(), module_full_name, module_cryptography$hazmat$bindings$openssl);
        assert(r != -1);
    }
#endif
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_f5eede0aaa9da5fbf6fc1c112aa8f591;
    ...
    // Frame without reuse.
    frame_f5eede0aaa9da5fbf6fc1c112aa8f591 = MAKE_MODULE_FRAME(codeobj_f5eede0aaa9da5fbf6fc1c112aa8f591, module_cryptography$hazmat$bindings$openssl);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack(frame_f5eede0aaa9da5fbf6fc1c112aa8f591);
    assert(Py_REFCNT(frame_f5eede0aaa9da5fbf6fc1c112aa8f591) == 2);
    ...
    // Framed code:
    {
        ...
        frame_f5eede0aaa9da5fbf6fc1c112aa8f591->m_frame.f_lineno = 1;
        {
    ...
    }
    {
        ...
        frame_f5eede0aaa9da5fbf6fc1c112aa8f591->m_frame.f_lineno = 5;
...
#if 0
    RESTORE_FRAME_EXCEPTION(frame_f5eede0aaa9da5fbf6fc1c112aa8f591);
#endif
    popFrameStack();

    assertFrameObject(frame_f5eede0aaa9da5fbf6fc1c112aa8f591);
    ...
    {
        exception_tb = MAKE_TRACEBACK(frame_f5eede0aaa9da5fbf6fc1c112aa8f591, exception_lineno);
    }
    else if (exception_tb->tb_frame != &frame_f5eede0aaa9da5fbf6fc1c112aa8f591->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_f5eede0aaa9da5fbf6fc1c112aa8f591, exception_lineno);
    }
