...
static void createModuleConstants(void) {
    const_str_digest_8a21550f68c4601774334b05737eb8f2 = UNSTREAM_STRING(&constant_bin[ 335451 ], 21, 0);
    const_float_0_9 = UNSTREAM_FLOAT(&constant_bin[ 335472 ]);
    const_int_pos_3760 = PyInt_FromLong(3760l);
    const_tuple_dde085f8e55d1c62c7c408697fac7cf3_tuple = PyMarshal_ReadObjectFromString((char *)&constant_bin[ 335480 ], 18805);
...
PyObject *modulecode_chardet$gb2312freq(char const *module_full_name) {
...
#ifdef _NUITKA_TRACE
    PRINT_STRING("chardet.gb2312freq: Calling createModuleConstants().\n");
#endif
    createModuleConstants();

    /* The code objects used by this module are created now. */
#ifdef _NUITKA_TRACE
    PRINT_STRING("chardet.gb2312freq: Calling createModuleCodeObjects().\n");
#endif
...
#else
    mdef_chardet$gb2312freq.m_name = module_full_name;
...
#if PYTHON_VERSION >= 300
    {
        int r = PyDict_SetItemString(PyImport_GetModuleDict(), module_full_name, module_chardet$gb2312freq);
        assert(r != -1);
    }
#endif
