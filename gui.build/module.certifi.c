...
static PyObject *const_str_digest_bf104775bcbaaed242cd21e69e0103fd;
...
static void createModuleConstants(void) {
    const_str_digest_5e67b9b4757ba8ed97d2c41596872ff0 = UNSTREAM_STRING(&constant_bin[ 259214 ], 10, 0);
    const_str_digest_e3372279ac622bcc524449ecfa1e730a = UNSTREAM_STRING(&constant_bin[ 259224 ], 16, 0);
    ...
    const_str_plain_NUITKA_PACKAGE_certifi = UNSTREAM_STRING(&constant_bin[ 259240 ], 22, 1);
    ...
    const_str_digest_bf104775bcbaaed242cd21e69e0103fd = UNSTREAM_STRING(&constant_bin[ 259262 ], 19, 0);
...
static PyCodeObject *codeobj_93ae0380562675eca3c7aa1696492476;

static void createModuleCodeObjects(void) {
    module_filename_obj = MAKE_RELATIVE_PATH(const_str_digest_bf104775bcbaaed242cd21e69e0103fd);
    codeobj_93ae0380562675eca3c7aa1696492476 = MAKE_CODEOBJECT(module_filename_obj, 1, CO_NOFREE, const_str_digest_e3372279ac622bcc524449ecfa1e730a, const_tuple_empty, 0, 0, 0);
}
...
PyObject *modulecode_certifi(char const *module_full_name) {
...
#else
    mdef_certifi.m_name = module_full_name;
...
#if PYTHON_VERSION >= 300
    {
        int r = PyDict_SetItemString(PyImport_GetModuleDict(), module_full_name, module_certifi);
        assert(r != -1);
    }
#endif
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_93ae0380562675eca3c7aa1696492476;
    ...
    // Frame without reuse.
    frame_93ae0380562675eca3c7aa1696492476 = MAKE_MODULE_FRAME(codeobj_93ae0380562675eca3c7aa1696492476, module_certifi);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack(frame_93ae0380562675eca3c7aa1696492476);
    assert(Py_REFCNT(frame_93ae0380562675eca3c7aa1696492476) == 2);
    ...
    // Framed code:
    {
        ...
        frame_93ae0380562675eca3c7aa1696492476->m_frame.f_lineno = 1;
        {
    ...
    }
    {
        ...
        tmp_assign_source_6 = IMPORT_NAME(tmp_import_name_from_2, const_str_plain_old_where);
        ...
        UPDATE_STRING_DICT1(moduledict_certifi, (Nuitka_StringObject *)const_str_plain_old_where, tmp_assign_source_6);
    }
    goto try_end_1;
...
#if 0
    RESTORE_FRAME_EXCEPTION(frame_93ae0380562675eca3c7aa1696492476);
#endif
    popFrameStack();

    assertFrameObject(frame_93ae0380562675eca3c7aa1696492476);
    ...
    {
        exception_tb = MAKE_TRACEBACK(frame_93ae0380562675eca3c7aa1696492476, exception_lineno);
    }
    else if (exception_tb->tb_frame != &frame_93ae0380562675eca3c7aa1696492476->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_93ae0380562675eca3c7aa1696492476, exception_lineno);
    }
...

    {
        ...
        tmp_assign_source_7 = const_str_digest_5e67b9b4757ba8ed97d2c41596872ff0;
        UPDATE_STRING_DICT0(moduledict_certifi, (Nuitka_StringObject *)const_str_plain___version__, tmp_assign_source_7);
    }
