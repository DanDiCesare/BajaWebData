/* Generated code for Python module 'asn1crypto._perf'
...
static PyObject *const_str_digest_13c9bd4f66f3db158271dc289585465d;
...
static void createModuleConstants(void) {
    const_str_plain__perf = UNSTREAM_STRING(&constant_bin[ 175678 ], 5, 1);
    const_str_digest_5ed93ae1de5463f3d40e13b98f3fa2d5 = UNSTREAM_STRING(&constant_bin[ 179653 ], 25, 0);
    const_str_plain_NUITKA_PACKAGE_asn1crypto__perf = UNSTREAM_STRING(&constant_bin[ 179678 ], 31, 1);
    ...
    const_str_digest_13c9bd4f66f3db158271dc289585465d = UNSTREAM_STRING(&constant_bin[ 179709 ], 28, 0);
...
static PyCodeObject *codeobj_c2a90b8043c7098c9707e0ef7ed6997a;

static void createModuleCodeObjects(void) {
    module_filename_obj = MAKE_RELATIVE_PATH(const_str_digest_13c9bd4f66f3db158271dc289585465d);
    codeobj_c2a90b8043c7098c9707e0ef7ed6997a = MAKE_CODEOBJECT(module_filename_obj, 1, CO_NOFREE, const_str_digest_5ed93ae1de5463f3d40e13b98f3fa2d5, const_tuple_empty, 0, 0, 0);
}
...
function_impl_code functable_asn1crypto$_perf[] = {
...
static PyObject *_reduce_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    function_impl_code *current = functable_asn1crypto$_perf;
    int offset = 0;
...
static PyObject *_create_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    if (offset > sizeof(functable_asn1crypto$_perf) || offset < 0) {
    ...
    struct Nuitka_FunctionObject *result = Nuitka_Function_New(
        functable_asn1crypto$_perf[offset],
        code_object->co_name,
#if PYTHON_VERSION >= 300
...
PyObject *modulecode_asn1crypto$_perf(char const *module_full_name) {
#if defined(_NUITKA_EXE) || PYTHON_VERSION >= 300
    static bool _init_done = false;

    // Modules might be imported repeatedly, which is to be ignored.
    if (_init_done) {
        return module_asn1crypto$_perf;
    } else {
        _init_done = true;
    }
#endif
...
#ifdef _NUITKA_TRACE
    PRINT_STRING("asn1crypto._perf: Calling setupMetaPathBasedLoader().\n");
#endif
...
#ifdef _NUITKA_TRACE
    PRINT_STRING("asn1crypto._perf: Calling createModuleConstants().\n");
#endif
    createModuleConstants();

    /* The code objects used by this module are created now. */
#ifdef _NUITKA_TRACE
    PRINT_STRING("asn1crypto._perf: Calling createModuleCodeObjects().\n");
#endif
    createModuleCodeObjects();

    // PRINT_STRING("in initasn1crypto$_perf\n");
...
#else
    mdef_asn1crypto$_perf.m_name = module_full_name;
...
#if PYTHON_VERSION >= 300
    {
        int r = PyDict_SetItemString(PyImport_GetModuleDict(), module_full_name, module_asn1crypto$_perf);
        assert(r != -1);
    }
#endif
...
#if PYTHON_VERSION >= 300
    UPDATE_STRING_DICT0(moduledict_asn1crypto$_perf, (Nuitka_StringObject *)const_str_plain___loader__, (PyObject *)&Nuitka_Loader_Type);
#endif
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_c2a90b8043c7098c9707e0ef7ed6997a;
    ...
    // Frame without reuse.
    frame_c2a90b8043c7098c9707e0ef7ed6997a = MAKE_MODULE_FRAME(codeobj_c2a90b8043c7098c9707e0ef7ed6997a, module_asn1crypto$_perf);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack(frame_c2a90b8043c7098c9707e0ef7ed6997a);
    assert(Py_REFCNT(frame_c2a90b8043c7098c9707e0ef7ed6997a) == 2);
    ...
    // Framed code:
    {
        ...
        frame_c2a90b8043c7098c9707e0ef7ed6997a->m_frame.f_lineno = 1;
        {
...
#if 0
    RESTORE_FRAME_EXCEPTION(frame_c2a90b8043c7098c9707e0ef7ed6997a);
#endif
    popFrameStack();

    assertFrameObject(frame_c2a90b8043c7098c9707e0ef7ed6997a);
    ...
    {
        exception_tb = MAKE_TRACEBACK(frame_c2a90b8043c7098c9707e0ef7ed6997a, exception_lineno);
    }
    else if (exception_tb->tb_frame != &frame_c2a90b8043c7098c9707e0ef7ed6997a->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_c2a90b8043c7098c9707e0ef7ed6997a, exception_lineno);
    }
