...
static void createModuleConstants(void) {
    ...
    const_str_digest_b1736aa08ebcc1a187702783619ce9b8 = UNSTREAM_STRING(&constant_bin[ 1160496 ], 41, 1);
    ...
    const_str_digest_ad8147c298b62c889289704513633c71 = UNSTREAM_STRING(&constant_bin[ 1160537 ], 35, 0);
    const_str_digest_279fe5e5c37c7c622bb9b8b9cc4ec218 = UNSTREAM_STRING(&constant_bin[ 1160572 ], 38, 0);
    const_str_digest_a726abd4d8f5ac5324113f941ee9c226 = UNSTREAM_STRING(&constant_bin[ 1160580 ], 18, 0);
...
static PyCodeObject *codeobj_526ccc284a3a86eaeed07f53f925dd10;

static void createModuleCodeObjects(void) {
    module_filename_obj = MAKE_RELATIVE_PATH(const_str_digest_279fe5e5c37c7c622bb9b8b9cc4ec218);
    codeobj_526ccc284a3a86eaeed07f53f925dd10 = MAKE_CODEOBJECT(module_filename_obj, 1, CO_NOFREE, const_str_digest_ad8147c298b62c889289704513633c71, const_tuple_empty, 0, 0, 0);
}
...
PyObject *modulecode_urllib3$packages$backports(char const *module_full_name) {
...
#else
    mdef_urllib3$packages$backports.m_name = module_full_name;
...
#if PYTHON_VERSION >= 300
    {
        int r = PyDict_SetItemString(PyImport_GetModuleDict(), module_full_name, module_urllib3$packages$backports);
        assert(r != -1);
    }
#endif
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_526ccc284a3a86eaeed07f53f925dd10;
    ...
    // Frame without reuse.
    frame_526ccc284a3a86eaeed07f53f925dd10 = MAKE_MODULE_FRAME(codeobj_526ccc284a3a86eaeed07f53f925dd10, module_urllib3$packages$backports);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack(frame_526ccc284a3a86eaeed07f53f925dd10);
    assert(Py_REFCNT(frame_526ccc284a3a86eaeed07f53f925dd10) == 2);
    ...
    // Framed code:
    {
        ...
        frame_526ccc284a3a86eaeed07f53f925dd10->m_frame.f_lineno = 1;
        {
...
#if 0
    RESTORE_FRAME_EXCEPTION(frame_526ccc284a3a86eaeed07f53f925dd10);
#endif
    popFrameStack();

    assertFrameObject(frame_526ccc284a3a86eaeed07f53f925dd10);
    ...
    {
        exception_tb = MAKE_TRACEBACK(frame_526ccc284a3a86eaeed07f53f925dd10, exception_lineno);
    }
    else if (exception_tb->tb_frame != &frame_526ccc284a3a86eaeed07f53f925dd10->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_526ccc284a3a86eaeed07f53f925dd10, exception_lineno);
    }
