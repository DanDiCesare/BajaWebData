...
static PyObject *const_dict_648873a866332a8f09dc7417bffcb7de;
...
static PyObject *const_dict_3e1a6c2864d172edca0842f783a1b92a;
...
static void createModuleConstants(void) {
    const_dict_648873a866332a8f09dc7417bffcb7de = PyMarshal_ReadObjectFromString((char *)&constant_bin[ 840246 ], 5042);
    const_str_digest_ec0f7eec38c0c14754a9bfcd76b4d751 = UNSTREAM_STRING(&constant_bin[ 845288 ], 16, 0);
    const_dict_7dd99487a3bc374c889517fc310d6954 = PyMarshal_ReadObjectFromString((char *)&constant_bin[ 845304 ], 8937);
    const_dict_3e1a6c2864d172edca0842f783a1b92a = PyMarshal_ReadObjectFromString((char *)&constant_bin[ 854241 ], 703);
...
PyObject *modulecode_idna$idnadata(char const *module_full_name) {
...
#else
    mdef_idna$idnadata.m_name = module_full_name;
...
#if PYTHON_VERSION >= 300
    {
        int r = PyDict_SetItemString(PyImport_GetModuleDict(), module_full_name, module_idna$idnadata);
        assert(r != -1);
    }
#endif
