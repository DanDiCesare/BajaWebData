...
static PyObject *const_str_digest_f848a4a113a2bb919179c2e0f20ee18b;
...
static void createModuleConstants(void) {
    const_str_digest_65ef04eb856a85792f5ff215b50ca7cf = UNSTREAM_STRING(&constant_bin[ 1124002 ], 28, 0);
    const_str_digest_f848a4a113a2bb919179c2e0f20ee18b = UNSTREAM_STRING(&constant_bin[ 1124030 ], 22, 0);
    ...
    const_str_digest_fb877889a7baac0f236274663e69c82a = UNSTREAM_STRING(&constant_bin[ 1124010 ], 19, 0);
    const_str_digest_c163711d15aed8007658cb930abf3665 = UNSTREAM_STRING(&constant_bin[ 1124052 ], 26, 0);
    const_str_digest_b9cb5aef76b50f3db090d948cda3c6d9 = UNSTREAM_STRING(&constant_bin[ 1124078 ], 70, 0);
...
static PyCodeObject *codeobj_25b0d2901a6e1a24f1588b422006973b;
static PyCodeObject *codeobj_20eb107310e642a21f1a854785867a61;

static void createModuleCodeObjects(void) {
    module_filename_obj = MAKE_RELATIVE_PATH(const_str_digest_f848a4a113a2bb919179c2e0f20ee18b);
    codeobj_25b0d2901a6e1a24f1588b422006973b = MAKE_CODEOBJECT(module_filename_obj, 1, CO_NOFREE, const_str_digest_65ef04eb856a85792f5ff215b50ca7cf, const_tuple_empty, 0, 0, 0);
    codeobj_20eb107310e642a21f1a854785867a61 = MAKE_CODEOBJECT(module_filename_obj, 8, CO_OPTIMIZED | CO_NEWLOCALS | CO_NOFREE, const_str_plain___init__, const_tuple_str_plain_self_str_plain_encoded_json_tuple, 2, 0, 0);
}
...
static PyObject *impl_simplejson$raw_json$$$function_1___init__(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    struct Nuitka_FrameObject *frame_20eb107310e642a21f1a854785867a61;
    ...
    static struct Nuitka_FrameObject *cache_frame_20eb107310e642a21f1a854785867a61 = NULL;
    PyObject *tmp_return_value = NULL;

    // Actual function body.
    MAKE_OR_REUSE_FRAME(cache_frame_20eb107310e642a21f1a854785867a61, codeobj_20eb107310e642a21f1a854785867a61, module_simplejson$raw_json, sizeof(void *)+sizeof(void *));
    frame_20eb107310e642a21f1a854785867a61 = cache_frame_20eb107310e642a21f1a854785867a61;

    // Push the new frame as the currently active one.
    pushFrameStack(frame_20eb107310e642a21f1a854785867a61);

    // Mark the frame object as in use, ref count 1 will be up for reuse.
    assert(Py_REFCNT(frame_20eb107310e642a21f1a854785867a61) == 2); // Frame stack
...
#if 0
    RESTORE_FRAME_EXCEPTION(frame_20eb107310e642a21f1a854785867a61);
#endif
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_20eb107310e642a21f1a854785867a61, exception_lineno);
    }
    else if (exception_tb->tb_frame != &frame_20eb107310e642a21f1a854785867a61->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_20eb107310e642a21f1a854785867a61, exception_lineno);
    }
    ...
    if (frame_20eb107310e642a21f1a854785867a61 == cache_frame_20eb107310e642a21f1a854785867a61) {
        Py_DECREF(frame_20eb107310e642a21f1a854785867a61);
    }
    cache_frame_20eb107310e642a21f1a854785867a61 = NULL;

    assertFrameObject(frame_20eb107310e642a21f1a854785867a61);
...
function_exception_exit:
    ...
    Py_DECREF(par_self);
    CHECK_OBJECT(par_encoded_json);
    Py_DECREF(par_encoded_json);    assert(exception_type);
...
static PyObject *MAKE_FUNCTION_simplejson$raw_json$$$function_1___init__() {
    struct Nuitka_FunctionObject *result = Nuitka_Function_New(
        ...
        NULL,
#endif
        codeobj_20eb107310e642a21f1a854785867a61,
        NULL,
#if PYTHON_VERSION >= 300
        NULL,
        NULL,
...
function_impl_code functable_simplejson$raw_json[] = {
    impl_simplejson$raw_json$$$function_1___init__,
    NULL
};
...
static PyObject *_reduce_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    function_impl_code *current = functable_simplejson$raw_json;
    int offset = 0;
...
static PyObject *_create_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    if (offset > sizeof(functable_simplejson$raw_json) || offset < 0) {
    ...
    struct Nuitka_FunctionObject *result = Nuitka_Function_New(
        functable_simplejson$raw_json[offset],
        code_object->co_name,
#if PYTHON_VERSION >= 300
...
PyObject *modulecode_simplejson$raw_json(char const *module_full_name) {
#if defined(_NUITKA_EXE) || PYTHON_VERSION >= 300
    static bool _init_done = false;

    // Modules might be imported repeatedly, which is to be ignored.
    if (_init_done) {
        return module_simplejson$raw_json;
    } else {
        _init_done = true;
    }
#endif
...
#ifdef _NUITKA_TRACE
    PRINT_STRING("simplejson.raw_json: Calling setupMetaPathBasedLoader().\n");
#endif
...
#ifdef _NUITKA_TRACE
    PRINT_STRING("simplejson.raw_json: Calling createModuleConstants().\n");
#endif
    createModuleConstants();

    /* The code objects used by this module are created now. */
#ifdef _NUITKA_TRACE
    PRINT_STRING("simplejson.raw_json: Calling createModuleCodeObjects().\n");
#endif
    createModuleCodeObjects();

    // PRINT_STRING("in initsimplejson$raw_json\n");
...
#else
    mdef_simplejson$raw_json.m_name = module_full_name;
...
#if PYTHON_VERSION >= 300
    {
        int r = PyDict_SetItemString(PyImport_GetModuleDict(), module_full_name, module_simplejson$raw_json);
        assert(r != -1);
    }
#endif
...
// Mark the execution in the "__spec__" value.
    ...
    int tmp_res;
    struct Nuitka_FrameObject *frame_25b0d2901a6e1a24f1588b422006973b;
    NUITKA_MAY_BE_UNUSED char const *type_description_1 = NULL;
    PyObject *exception_type = NULL;
    PyObject *exception_value = NULL;
    PyTracebackObject *exception_tb = NULL;
    ...
    // Frame without reuse.
    frame_25b0d2901a6e1a24f1588b422006973b = MAKE_MODULE_FRAME(codeobj_25b0d2901a6e1a24f1588b422006973b, module_simplejson$raw_json);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack(frame_25b0d2901a6e1a24f1588b422006973b);
    assert(Py_REFCNT(frame_25b0d2901a6e1a24f1588b422006973b) == 2);
    ...
    }
    {
        ...
        frame_25b0d2901a6e1a24f1588b422006973b->m_frame.f_lineno = 4;
        {
...
#if 0
    RESTORE_FRAME_EXCEPTION(frame_25b0d2901a6e1a24f1588b422006973b);
#endif
    popFrameStack();

    assertFrameObject(frame_25b0d2901a6e1a24f1588b422006973b);
    ...
    if ( exception_tb == NULL )
    {
        exception_tb = MAKE_TRACEBACK(frame_25b0d2901a6e1a24f1588b422006973b, exception_lineno);
    }
    else if (exception_tb->tb_frame != &frame_25b0d2901a6e1a24f1588b422006973b->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_25b0d2901a6e1a24f1588b422006973b, exception_lineno);
    }
