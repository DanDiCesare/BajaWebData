/* Generated code for Python module 'backports'
...
static void createModuleConstants(void) {
    const_str_digest_db245500be6aea4306e1f480a7e2f880 = UNSTREAM_STRING(&constant_bin[ 259091 ], 18, 0);
    const_str_plain_NUITKA_PACKAGE_backports = UNSTREAM_STRING(&constant_bin[ 259109 ], 24, 1);
    const_str_digest_f13950bd87f5bf12522860f19fce16ce = UNSTREAM_STRING(&constant_bin[ 259133 ], 21, 0);
...
static PyCodeObject *codeobj_881a19d02d99718bbde13816a3005be1;

static void createModuleCodeObjects(void) {
    module_filename_obj = MAKE_RELATIVE_PATH(const_str_digest_f13950bd87f5bf12522860f19fce16ce);
    codeobj_881a19d02d99718bbde13816a3005be1 = MAKE_CODEOBJECT(module_filename_obj, 1, CO_NOFREE, const_str_digest_db245500be6aea4306e1f480a7e2f880, const_tuple_empty, 0, 0, 0);
}
...
function_impl_code functable_backports[] = {
...
static PyObject *_reduce_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    function_impl_code *current = functable_backports;
    int offset = 0;
...
static PyObject *_create_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    if (offset > sizeof(functable_backports) || offset < 0) {
...
PyObject *modulecode_backports(char const *module_full_name) {
#if defined(_NUITKA_EXE) || PYTHON_VERSION >= 300
    static bool _init_done = false;

    // Modules might be imported repeatedly, which is to be ignored.
    if (_init_done) {
        return module_backports;
    } else {
        _init_done = true;
    }
#endif
...
#ifdef _NUITKA_TRACE
    PRINT_STRING("backports: Calling setupMetaPathBasedLoader().\n");
#endif
...
#ifdef _NUITKA_TRACE
    PRINT_STRING("backports: Calling createModuleConstants().\n");
#endif
    createModuleConstants();

    /* The code objects used by this module are created now. */
#ifdef _NUITKA_TRACE
    PRINT_STRING("backports: Calling createModuleCodeObjects().\n");
#endif
    createModuleCodeObjects();

    // PRINT_STRING("in initbackports\n");
...
#else
    mdef_backports.m_name = module_full_name;
...
#if PYTHON_VERSION >= 300
    {
        int r = PyDict_SetItemString(PyImport_GetModuleDict(), module_full_name, module_backports);
        assert(r != -1);
    }
#endif
...
#if PYTHON_VERSION >= 300
    UPDATE_STRING_DICT0(moduledict_backports, (Nuitka_StringObject *)const_str_plain___loader__, (PyObject *)&Nuitka_Loader_Type);
#endif
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_881a19d02d99718bbde13816a3005be1;
    ...
    // Frame without reuse.
    frame_881a19d02d99718bbde13816a3005be1 = MAKE_MODULE_FRAME(codeobj_881a19d02d99718bbde13816a3005be1, module_backports);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack(frame_881a19d02d99718bbde13816a3005be1);
    assert(Py_REFCNT(frame_881a19d02d99718bbde13816a3005be1) == 2);
    ...
    // Framed code:
    {
        ...
        frame_881a19d02d99718bbde13816a3005be1->m_frame.f_lineno = 1;
        {
...
#if 0
    RESTORE_FRAME_EXCEPTION(frame_881a19d02d99718bbde13816a3005be1);
#endif
    popFrameStack();

    assertFrameObject(frame_881a19d02d99718bbde13816a3005be1);
    ...
    {
        exception_tb = MAKE_TRACEBACK(frame_881a19d02d99718bbde13816a3005be1, exception_lineno);
    }
    else if (exception_tb->tb_frame != &frame_881a19d02d99718bbde13816a3005be1->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_881a19d02d99718bbde13816a3005be1, exception_lineno);
    }
