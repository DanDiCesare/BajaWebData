...
static PyObject *const_str_digest_8de1538887f5342750a34773bce88d14;
...
static void createModuleConstants(void) {
    const_str_digest_8de1538887f5342750a34773bce88d14 = UNSTREAM_STRING(&constant_bin[ 486431 ], 26, 0);
    const_str_plain_HEBREW_LANG_MODEL = UNSTREAM_STRING(&constant_bin[ 486457 ], 17, 1);
    const_tuple_96aea69e7c6c4b34b6c5234187423b87_tuple = PyMarshal_ReadObjectFromString((char *)&constant_bin[ 486474 ], 20485);
    const_float_0_984004 = UNSTREAM_FLOAT(&constant_bin[ 506959 ]);
    const_tuple_4f19fa3634bb485716df7f8f5e81152b_tuple = PyMarshal_ReadObjectFromString((char *)&constant_bin[ 506967 ], 1285);
    const_str_plain_WIN1255_CHAR_TO_ORDER_MAP = UNSTREAM_STRING(&constant_bin[ 508252 ], 25, 1);
...
static void createModuleCodeObjects(void) {
    module_filename_obj = MAKE_RELATIVE_PATH(const_str_digest_8de1538887f5342750a34773bce88d14);
}
...
PyObject *modulecode_chardet$langhebrewmodel(char const *module_full_name) {
...
#ifdef _NUITKA_TRACE
    PRINT_STRING("chardet.langhebrewmodel: Calling createModuleConstants().\n");
#endif
    createModuleConstants();

    /* The code objects used by this module are created now. */
#ifdef _NUITKA_TRACE
    PRINT_STRING("chardet.langhebrewmodel: Calling createModuleCodeObjects().\n");
#endif
...
#else
    mdef_chardet$langhebrewmodel.m_name = module_full_name;
...
#if PYTHON_VERSION >= 300
    {
        int r = PyDict_SetItemString(PyImport_GetModuleDict(), module_full_name, module_chardet$langhebrewmodel);
        assert(r != -1);
    }
#endif
...
// Mark the execution in the "__spec__" value.
    ...
    }
    {
        ...
        tmp_assign_source_3 = const_tuple_4f19fa3634bb485716df7f8f5e81152b_tuple;
        UPDATE_STRING_DICT0(moduledict_chardet$langhebrewmodel, (Nuitka_StringObject *)const_str_plain_WIN1255_CHAR_TO_ORDER_MAP, tmp_assign_source_3);
    }
    {
        PyObject *tmp_assign_source_4;
        tmp_assign_source_4 = const_tuple_96aea69e7c6c4b34b6c5234187423b87_tuple;
        UPDATE_STRING_DICT0(moduledict_chardet$langhebrewmodel, (Nuitka_StringObject *)const_str_plain_HEBREW_LANG_MODEL, tmp_assign_source_4);
    }
    {
        ...
        tmp_mvar_value_1 = GET_STRING_DICT_VALUE(moduledict_chardet$langhebrewmodel, (Nuitka_StringObject *)const_str_plain_WIN1255_CHAR_TO_ORDER_MAP);

        if (unlikely(tmp_mvar_value_1 == NULL)) {
            tmp_mvar_value_1 = GET_STRING_DICT_VALUE(dict_builtin, (Nuitka_StringObject *)const_str_plain_WIN1255_CHAR_TO_ORDER_MAP);
        }
        ...
        assert(!(tmp_res != 0));
        tmp_mvar_value_2 = GET_STRING_DICT_VALUE(moduledict_chardet$langhebrewmodel, (Nuitka_StringObject *)const_str_plain_HEBREW_LANG_MODEL);

        if (unlikely(tmp_mvar_value_2 == NULL)) {
            tmp_mvar_value_2 = GET_STRING_DICT_VALUE(dict_builtin, (Nuitka_StringObject *)const_str_plain_HEBREW_LANG_MODEL);
        }
        ...
        assert(!(tmp_res != 0));
        UPDATE_STRING_DICT1(moduledict_chardet$langhebrewmodel, (Nuitka_StringObject *)const_str_plain_Win1255HebrewModel, tmp_assign_source_5);
    }
