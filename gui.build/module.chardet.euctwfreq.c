...
static void createModuleConstants(void) {
    const_str_digest_d073256371d10537ed7e89e379ec4bdf = UNSTREAM_STRING(&constant_bin[ 308465 ], 20, 0);
    const_tuple_c7857aa12bb2e86b5fb641a93cd629e0_tuple = PyMarshal_ReadObjectFromString((char *)&constant_bin[ 308485 ], 26885);
...
PyObject *modulecode_chardet$euctwfreq(char const *module_full_name) {
...
#ifdef _NUITKA_TRACE
    PRINT_STRING("chardet.euctwfreq: Calling createModuleConstants().\n");
#endif
    createModuleConstants();

    /* The code objects used by this module are created now. */
#ifdef _NUITKA_TRACE
    PRINT_STRING("chardet.euctwfreq: Calling createModuleCodeObjects().\n");
#endif
...
#else
    mdef_chardet$euctwfreq.m_name = module_full_name;
...
#if PYTHON_VERSION >= 300
    {
        int r = PyDict_SetItemString(PyImport_GetModuleDict(), module_full_name, module_chardet$euctwfreq);
        assert(r != -1);
    }
#endif
