...
static void createModuleConstants(void) {
    const_str_plain_IBM866 = UNSTREAM_STRING(&constant_bin[ 434844 ], 6, 1);
    const_str_plain_MacCyrillic = UNSTREAM_STRING(&constant_bin[ 17720 ], 11, 1);
    const_tuple_b24235f9a763afce8962d2938259e649_tuple = PyMarshal_ReadObjectFromString((char *)&constant_bin[ 434850 ], 1285);
    const_str_plain_latin5_char_to_order_map = UNSTREAM_STRING(&constant_bin[ 436135 ], 24, 1);
    const_tuple_f18bdee9536a45fe5ae287fb6355492a_tuple = PyMarshal_ReadObjectFromString((char *)&constant_bin[ 436159 ], 1285);
    const_tuple_534421f243659b6bda00351214dd02e2_tuple = PyMarshal_ReadObjectFromString((char *)&constant_bin[ 437444 ], 1285);
    const_str_plain_RussianLangModel = UNSTREAM_STRING(&constant_bin[ 438729 ], 16, 1);
    const_str_plain_win1251_char_to_order_map = UNSTREAM_STRING(&constant_bin[ 438745 ], 25, 1);
    const_tuple_f8e41cfab8cb474168ecd9a8e1d7cea1_tuple = PyMarshal_ReadObjectFromString((char *)&constant_bin[ 438770 ], 1285);
    const_tuple_ffd1e1f94e28d6aae394e365bb952ebe_tuple = PyMarshal_ReadObjectFromString((char *)&constant_bin[ 440055 ], 1285);
    const_str_plain_IBM866_char_to_order_map = UNSTREAM_STRING(&constant_bin[ 441340 ], 24, 1);
    const_str_plain_KOI8R_char_to_order_map = UNSTREAM_STRING(&constant_bin[ 441364 ], 23, 1);
    const_tuple_9222b66a29def824eb1194a0241b88ae_tuple = PyMarshal_ReadObjectFromString((char *)&constant_bin[ 441387 ], 20485);
    const_str_plain_IBM855 = UNSTREAM_STRING(&constant_bin[ 461872 ], 6, 1);
    const_str_plain_macCyrillic_char_to_order_map = UNSTREAM_STRING(&constant_bin[ 461878 ], 29, 1);
    const_str_plain_IBM855_char_to_order_map = UNSTREAM_STRING(&constant_bin[ 461907 ], 24, 1);
    const_str_digest_6ce9cc579b89a18ecd64c58d6deebbd4 = UNSTREAM_STRING(&constant_bin[ 461931 ], 28, 0);
    const_str_digest_0c808d739d4314a3145ee0e332b5d593 = UNSTREAM_STRING(&constant_bin[ 461959 ], 6, 0);
    const_float_0_976601 = UNSTREAM_FLOAT(&constant_bin[ 461965 ]);
    const_tuple_666844a46456f676cd51b40483cca4f3_tuple = PyMarshal_ReadObjectFromString((char *)&constant_bin[ 461973 ], 1285);
    const_str_plain_Russian = UNSTREAM_STRING(&constant_bin[ 438729 ], 7, 1);
...
function_impl_code functable_chardet$langcyrillicmodel[] = {
...
static PyObject *_reduce_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    function_impl_code *current = functable_chardet$langcyrillicmodel;
    int offset = 0;
...
static PyObject *_create_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    if (offset > sizeof(functable_chardet$langcyrillicmodel) || offset < 0) {
    ...
    struct Nuitka_FunctionObject *result = Nuitka_Function_New(
        functable_chardet$langcyrillicmodel[offset],
        code_object->co_name,
#if PYTHON_VERSION >= 300
...
#endif
        module_chardet$langcyrillicmodel,
        doc,
        0
    );
...
PyObject *modulecode_chardet$langcyrillicmodel(char const *module_full_name) {
...
#ifdef _NUITKA_TRACE
    PRINT_STRING("chardet.langcyrillicmodel: Calling setupMetaPathBasedLoader().\n");
#endif
...
#ifdef _NUITKA_TRACE
    PRINT_STRING("chardet.langcyrillicmodel: Calling createModuleConstants().\n");
#endif
    createModuleConstants();

    /* The code objects used by this module are created now. */
#ifdef _NUITKA_TRACE
    PRINT_STRING("chardet.langcyrillicmodel: Calling createModuleCodeObjects().\n");
#endif
    createModuleCodeObjects();

    // PRINT_STRING("in initchardet$langcyrillicmodel\n");
...
#else
    mdef_chardet$langcyrillicmodel.m_name = module_full_name;
...
#if PYTHON_VERSION >= 300
    {
        int r = PyDict_SetItemString(PyImport_GetModuleDict(), module_full_name, module_chardet$langcyrillicmodel);
        assert(r != -1);
    }
#endif
...
// Mark the execution in the "__spec__" value.
    ...
    }
    {
        ...
        tmp_mvar_value_1 = GET_STRING_DICT_VALUE(moduledict_chardet$langcyrillicmodel, (Nuitka_StringObject *)const_str_plain_KOI8R_char_to_order_map);

        if (unlikely(tmp_mvar_value_1 == NULL)) {
            tmp_mvar_value_1 = GET_STRING_DICT_VALUE(dict_builtin, (Nuitka_StringObject *)const_str_plain_KOI8R_char_to_order_map);
        }
        ...
        assert(!(tmp_res != 0));
        tmp_mvar_value_2 = GET_STRING_DICT_VALUE(moduledict_chardet$langcyrillicmodel, (Nuitka_StringObject *)const_str_plain_RussianLangModel);

        if (unlikely(tmp_mvar_value_2 == NULL)) {
            tmp_mvar_value_2 = GET_STRING_DICT_VALUE(dict_builtin, (Nuitka_StringObject *)const_str_plain_RussianLangModel);
        }
    ...
    }
    {
        ...
        tmp_mvar_value_3 = GET_STRING_DICT_VALUE(moduledict_chardet$langcyrillicmodel, (Nuitka_StringObject *)const_str_plain_win1251_char_to_order_map);

        if (unlikely(tmp_mvar_value_3 == NULL)) {
            tmp_mvar_value_3 = GET_STRING_DICT_VALUE(dict_builtin, (Nuitka_StringObject *)const_str_plain_win1251_char_to_order_map);
        }
    ...
    }
    {
        ...
        tmp_mvar_value_5 = GET_STRING_DICT_VALUE(moduledict_chardet$langcyrillicmodel, (Nuitka_StringObject *)const_str_plain_latin5_char_to_order_map);

        if (unlikely(tmp_mvar_value_5 == NULL)) {
            tmp_mvar_value_5 = GET_STRING_DICT_VALUE(dict_builtin, (Nuitka_StringObject *)const_str_plain_latin5_char_to_order_map);
        }

        CHECK_OBJECT(tmp_mvar_value_5);
        tmp_dict_value_13 = tmp_mvar_value_5;
        tmp_dict_key_13 = const_str_plain_char_to_order_map;
        tmp_assign_source_12 = _PyDict_NewPresized( 6 );
        tmp_res = PyDict_SetItem(tmp_assign_source_12, tmp_dict_key_13, tmp_dict_value_13);
        assert(!(tmp_res != 0));
        ...
        tmp_dict_value_14 = tmp_mvar_value_6;
        tmp_dict_key_14 = const_str_plain_precedence_matrix;
        tmp_res = PyDict_SetItem(tmp_assign_source_12, tmp_dict_key_14, tmp_dict_value_14);
        assert(!(tmp_res != 0));
        tmp_dict_value_15 = const_float_0_976601;
        tmp_dict_key_15 = const_str_plain_typical_positive_ratio;
        tmp_res = PyDict_SetItem(tmp_assign_source_12, tmp_dict_key_15, tmp_dict_value_15);
        assert(!(tmp_res != 0));
        tmp_dict_value_16 = Py_False;
        tmp_dict_key_16 = const_str_plain_keep_english_letter;
        tmp_res = PyDict_SetItem(tmp_assign_source_12, tmp_dict_key_16, tmp_dict_value_16);
        assert(!(tmp_res != 0));
        tmp_dict_value_17 = const_str_digest_aada818c73a52b8f999cbecf8cef2e77;
        tmp_dict_key_17 = const_str_plain_charset_name;
        tmp_res = PyDict_SetItem(tmp_assign_source_12, tmp_dict_key_17, tmp_dict_value_17);
        assert(!(tmp_res != 0));
        tmp_dict_value_18 = const_str_plain_Russian;
        tmp_dict_key_18 = const_str_plain_language;
        tmp_res = PyDict_SetItem(tmp_assign_source_12, tmp_dict_key_18, tmp_dict_value_18);
        assert(!(tmp_res != 0));
    ...
    }
    {
        ...
        tmp_mvar_value_7 = GET_STRING_DICT_VALUE(moduledict_chardet$langcyrillicmodel, (Nuitka_StringObject *)const_str_plain_macCyrillic_char_to_order_map);

        if (unlikely(tmp_mvar_value_7 == NULL)) {
            tmp_mvar_value_7 = GET_STRING_DICT_VALUE(dict_builtin, (Nuitka_StringObject *)const_str_plain_macCyrillic_char_to_order_map);
        }

        CHECK_OBJECT(tmp_mvar_value_7);
        tmp_dict_value_19 = tmp_mvar_value_7;
        tmp_dict_key_19 = const_str_plain_char_to_order_map;
        tmp_assign_source_13 = _PyDict_NewPresized( 6 );
        tmp_res = PyDict_SetItem(tmp_assign_source_13, tmp_dict_key_19, tmp_dict_value_19);
        assert(!(tmp_res != 0));
        ...
        tmp_dict_value_20 = tmp_mvar_value_8;
        tmp_dict_key_20 = const_str_plain_precedence_matrix;
        tmp_res = PyDict_SetItem(tmp_assign_source_13, tmp_dict_key_20, tmp_dict_value_20);
        assert(!(tmp_res != 0));
        tmp_dict_value_21 = const_float_0_976601;
        tmp_dict_key_21 = const_str_plain_typical_positive_ratio;
        tmp_res = PyDict_SetItem(tmp_assign_source_13, tmp_dict_key_21, tmp_dict_value_21);
        assert(!(tmp_res != 0));
        tmp_dict_value_22 = Py_False;
        tmp_dict_key_22 = const_str_plain_keep_english_letter;
        tmp_res = PyDict_SetItem(tmp_assign_source_13, tmp_dict_key_22, tmp_dict_value_22);
        assert(!(tmp_res != 0));
        tmp_dict_value_23 = const_str_plain_MacCyrillic;
        tmp_dict_key_23 = const_str_plain_charset_name;
        tmp_res = PyDict_SetItem(tmp_assign_source_13, tmp_dict_key_23, tmp_dict_value_23);
        assert(!(tmp_res != 0));
        tmp_dict_value_24 = const_str_plain_Russian;
        tmp_dict_key_24 = const_str_plain_language;
        tmp_res = PyDict_SetItem(tmp_assign_source_13, tmp_dict_key_24, tmp_dict_value_24);
        assert(!(tmp_res != 0));
    ...
    }
    {
        ...
        tmp_mvar_value_9 = GET_STRING_DICT_VALUE(moduledict_chardet$langcyrillicmodel, (Nuitka_StringObject *)const_str_plain_IBM866_char_to_order_map);

        if (unlikely(tmp_mvar_value_9 == NULL)) {
            tmp_mvar_value_9 = GET_STRING_DICT_VALUE(dict_builtin, (Nuitka_StringObject *)const_str_plain_IBM866_char_to_order_map);
        }

        CHECK_OBJECT(tmp_mvar_value_9);
        tmp_dict_value_25 = tmp_mvar_value_9;
        tmp_dict_key_25 = const_str_plain_char_to_order_map;
        tmp_assign_source_14 = _PyDict_NewPresized( 6 );
        tmp_res = PyDict_SetItem(tmp_assign_source_14, tmp_dict_key_25, tmp_dict_value_25);
        assert(!(tmp_res != 0));
        ...
        tmp_dict_value_26 = tmp_mvar_value_10;
        tmp_dict_key_26 = const_str_plain_precedence_matrix;
        tmp_res = PyDict_SetItem(tmp_assign_source_14, tmp_dict_key_26, tmp_dict_value_26);
        assert(!(tmp_res != 0));
        tmp_dict_value_27 = const_float_0_976601;
        tmp_dict_key_27 = const_str_plain_typical_positive_ratio;
        tmp_res = PyDict_SetItem(tmp_assign_source_14, tmp_dict_key_27, tmp_dict_value_27);
        assert(!(tmp_res != 0));
        tmp_dict_value_28 = Py_False;
        tmp_dict_key_28 = const_str_plain_keep_english_letter;
        tmp_res = PyDict_SetItem(tmp_assign_source_14, tmp_dict_key_28, tmp_dict_value_28);
        assert(!(tmp_res != 0));
        tmp_dict_value_29 = const_str_plain_IBM866;
        tmp_dict_key_29 = const_str_plain_charset_name;
        tmp_res = PyDict_SetItem(tmp_assign_source_14, tmp_dict_key_29, tmp_dict_value_29);
        assert(!(tmp_res != 0));
        tmp_dict_value_30 = const_str_plain_Russian;
        tmp_dict_key_30 = const_str_plain_language;
        tmp_res = PyDict_SetItem(tmp_assign_source_14, tmp_dict_key_30, tmp_dict_value_30);
        assert(!(tmp_res != 0));
    ...
    }
    {
        ...
        tmp_mvar_value_11 = GET_STRING_DICT_VALUE(moduledict_chardet$langcyrillicmodel, (Nuitka_StringObject *)const_str_plain_IBM855_char_to_order_map);

        if (unlikely(tmp_mvar_value_11 == NULL)) {
            tmp_mvar_value_11 = GET_STRING_DICT_VALUE(dict_builtin, (Nuitka_StringObject *)const_str_plain_IBM855_char_to_order_map);
        }

        CHECK_OBJECT(tmp_mvar_value_11);
        tmp_dict_value_31 = tmp_mvar_value_11;
        tmp_dict_key_31 = const_str_plain_char_to_order_map;
        tmp_assign_source_15 = _PyDict_NewPresized( 6 );
        tmp_res = PyDict_SetItem(tmp_assign_source_15, tmp_dict_key_31, tmp_dict_value_31);
        assert(!(tmp_res != 0));
        ...
        tmp_dict_value_32 = tmp_mvar_value_12;
        tmp_dict_key_32 = const_str_plain_precedence_matrix;
        tmp_res = PyDict_SetItem(tmp_assign_source_15, tmp_dict_key_32, tmp_dict_value_32);
        assert(!(tmp_res != 0));
        tmp_dict_value_33 = const_float_0_976601;
        tmp_dict_key_33 = const_str_plain_typical_positive_ratio;
        tmp_res = PyDict_SetItem(tmp_assign_source_15, tmp_dict_key_33, tmp_dict_value_33);
        assert(!(tmp_res != 0));
        tmp_dict_value_34 = Py_False;
        tmp_dict_key_34 = const_str_plain_keep_english_letter;
        tmp_res = PyDict_SetItem(tmp_assign_source_15, tmp_dict_key_34, tmp_dict_value_34);
        assert(!(tmp_res != 0));
        tmp_dict_value_35 = const_str_plain_IBM855;
        tmp_dict_key_35 = const_str_plain_charset_name;
        tmp_res = PyDict_SetItem(tmp_assign_source_15, tmp_dict_key_35, tmp_dict_value_35);
        assert(!(tmp_res != 0));
        tmp_dict_value_36 = const_str_plain_Russian;
        tmp_dict_key_36 = const_str_plain_language;
        tmp_res = PyDict_SetItem(tmp_assign_source_15, tmp_dict_key_36, tmp_dict_value_36);
        assert(!(tmp_res != 0));
